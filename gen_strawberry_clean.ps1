...
function Build-Seamless-Cone {
    ...
    Write-Output "Successfully rebuilt: $DstPath"
}

Build-Seamless-Cone -SrcPath 'C:\Users\ADMIN\.gemini\antigravity\brain\9e5f5974-611b-4d1c-bb67-0888dcc30838\strawberry_icecream_1788972051158.jpg' -DstPath 'assets\images\strawberry.png' -BgMinB 95 -EdgeTolerance 22.0
